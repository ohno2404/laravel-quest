...
<ul class="nav nav-tabs nav-justified mt-5 mb-2">
        <li class="nav-item nav-link {{ Request::is('users/' . $user->id) ? 'active' : '' }}"><a href="{{ route('users.show',['user'=>$user->id]) }}" class="">動 画<br><div class="badge badge-secondary">{{ $count_movies }}</div></a></li>
